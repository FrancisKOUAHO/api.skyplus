const AutoConnectLinkedIn = {
    config: {
        ...
        addNote: true,
        note: "Bonjour {{name}}, Un grand merci à vous de m'avoir accepté dans votre réseau professionnel. Très belle journée ☀"
    },
    ...
    scrollBottom: async function (data, config) {
